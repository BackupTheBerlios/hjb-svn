...
public class FloatPropertyValueCopier extends BaseEncodedValueCopier {

    public FloatPropertyValueCopier() {
    ...
    public String getAsEncodedValue(String name, Message message)
            throws HJBException {
        try {
            return encode(new Float(message.getFloatProperty(name)));
        } catch (JMSException e) {
