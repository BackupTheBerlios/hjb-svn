 ...
 * that produces {@link DeleteSession}.
 * 
 ...
 * @author Tim Emiola
 */
public class DeleteSessionGenerator extends PatternMatchingCommandGenerator {
    ...
    protected void constructCommandFrom(HttpServletRequest request, HJBRoot root)
        ...
        HJBConnection connection = walker.findConnection(providerName,
                                                         factoryName,
                                                         connectionIndex);
        this.generatedCommand = new DeleteSession(connection, sessionIndex);
    }
