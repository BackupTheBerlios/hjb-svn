...
public class CollectFromConsumerGeneratorTest extends
    ...
    public void testMatchWorksCorrectly() {
        ...
        assertTrue(generator.matches("/foo/bar/connection-1/session-0/consumer-0/collect"));
        assertTrue(generator.matches("/foo/baz/multiple/slashes/connection-5/session-4/consumer-5/collect"));
    }
    ...
    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        ...
        mockRequest.stubs()
            .method("getPathInfo")
            .will(returnValue("/testProvider/testFactory/with/slash/connection-0/session-0/consumer-0/collect"));
        ...
        assertTrue(generator.getGeneratedCommand() instanceof CollectFromConsumer);
    }

    protected void setUp() throws Exception {
        super.setUp();
        generator = new CollectFromConsumerGenerator();
    }
}
