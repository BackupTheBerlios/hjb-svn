...
public class HJBSessionProducers_0_8_2Test extends BaseHJBTestCase {

    public void testHJBSessionProducersThrowsIllegalArgumentExceptionOnNullConnection() {
        try {
            new HJBSessionProducers_0_8_2(null);
    ...
    public void testCreateProducerThrowsIfSessionIsNotThere() throws Exception {
        ...
        HJBSessionProducers_0_8_2 producers = new HJBSessionProducers_0_8_2(testConnection);
        try {
