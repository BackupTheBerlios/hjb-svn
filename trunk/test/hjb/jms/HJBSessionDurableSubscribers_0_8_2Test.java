...
public class HJBSessionDurableSubscribers_0_8_2Test extends BaseHJBTestCase {

    public void testHJBSessionDurableSubscribersThrowsIllegalArgumentExceptionOnNullConnection() {
        try {
            new HJBSessionDurableSubscribers_0_8_2(null);
    ...
    public void testCreateSubscriberThrowsIfSessionIsNotThere()
        ...
        HJBSessionDurableSubscribers_0_8_2 subscribers = new HJBSessionDurableSubscribers_0_8_2(testConnection);
        try {
