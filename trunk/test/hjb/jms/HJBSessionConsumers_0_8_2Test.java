...
public class HJBSessionConsumers_0_8_2Test extends BaseHJBTestCase {

    public void testHJBSessionConsumersThrowsIllegalArgumentExceptionOnNullConnection() {
        try {
            new HJBSessionConsumers_0_8_2(null);
    ...
    public void testCreateConsumerThrowsIfSessionIsNotThere() throws Exception {
        ...
        HJBSessionConsumers_0_8_2 consumers = new HJBSessionConsumers_0_8_2(testConnection);
        try {
