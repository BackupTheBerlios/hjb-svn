...
public class ReadMetaDataTest extends MockObjectTestCase {
    ...
    public ConnectionMetaData makeMockMetaData() {
        ...
        mockMetaData.stubs().method("getJMSProviderName").will(returnValue("HJB Test"));
        mockMetaData.stubs().method("getProviderMajorVersion").will(returnValue(0));
        mockMetaData.stubs().method("getProviderMinorVersion").will(returnValue(7));
        mockMetaData.stubs().method("getProviderVersion").will(returnValue("0.7"));
        mockMetaData.stubs().method("getJMSXPropertyNames").will(returnValue(Collections.enumeration(new ArrayList())));
    ...
    public void testExecuteStartsAConnection() {
        ...
        connectionMock.expects(once()).method("getMetaData").will(returnValue(makeMockMetaData()));
