...
public class LongPropertyValueCopierTest extends MockObjectTestCase {
    ...
    public LongPropertyValueCopierTest() {
    ...
    public void testCanBeEncodedReturnsFalseOnJMSException() {
        Message testMessage = messageBuilder.throwsJMSMessageOnMethodNamed("getLongProperty");
    ...
    public void testAddToMessageThrowsHJBExceptionOnJMSException() {
        Message testMessage = messageBuilder.throwsJMSMessageOnMethodNamed("setLongProperty");
        LongPropertyValueCopier testCopier = new LongPropertyValueCopier();
        try {
