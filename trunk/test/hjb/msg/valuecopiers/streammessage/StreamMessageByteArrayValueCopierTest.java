...
public class StreamMessageByteArrayValueCopierTest extends MockObjectTestCase {
    ...
    public StreamMessageByteArrayValueCopierTest() {
    ...
    // public void
    // testGetAsEncodedValueThrowsHJBExceptionOnIncorrectMessageType() {
    // messageBuilder = new MockMessageBuilder(this, Message.class);
    // Message testMessage = messageBuilder.nothingExpected();
    // StreamMessageByteArrayValueCopier testCopier = new
    // StreamMessageByteArrayValueCopier(valuesRead);
    // try {
    ...
    // Message testMessage =
    // messageBuilder.returnsExpectedValueFromNamedMethod("readBytes",
    // "testMessage",
    ...
    // OK_EXPECTED_DECODED_BARRAYS[1], testCopier.getAsEncodedValue("testName",
    // testMessage));
    // }
    //
