...
public class ReceiveFromConsumerGeneratorTest extends
    ...
    public void testMatchWorksCorrectly() {
        ...
        assertTrue(generator.matches("/foo/bar/connection-1/session-0/consumer-0/receive"));
        assertTrue(generator.matches("/foo/baz/connection-5/session-4/consumer-5/receive"));
    }

    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        Mock mockRequest = generateMockRequest();
        mockRequest.stubs().method("getPathInfo").will(returnValue("/testProvider/testFactory/connection-0/session-0/consumer-0/receive"));
