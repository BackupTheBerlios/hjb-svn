...
public class ReceiveFromSubscriberGeneratorTest extends
    ...
    public void testMatchWorksCorrectly() {
        ...
        assertTrue(generator.matches("/foo/baz/multiple/slashes/connection-5/session-4/subscriber-5/receive"));
    }
    ...
    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        ...
        mockRequest.stubs()
            .method("getPathInfo")
            .will(returnValue("/testProvider/testFactory/with/slash/connection-0/session-0/subscriber-0/receive"));
    ...
    protected void setUp() throws Exception {
        super.setUp();
        generator = new ReceiveFromSubscriberGenerator();
    }
}
