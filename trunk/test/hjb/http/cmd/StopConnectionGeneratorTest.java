...
public class StopConnectionGeneratorTest extends
    ...
    public void testMatchWorksCorrectly() {
        ...
        assertTrue(generator.matches("/foo/bar/connection-124/stop"));
    ...
    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        ...
        mockRequest.expects(atLeastOnce()).method("getPathInfo").will(returnValue("/testProvider/testFactory/connection-0/stop"));
