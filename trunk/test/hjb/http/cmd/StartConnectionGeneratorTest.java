...
public class StartConnectionGeneratorTest extends
    ...
    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        ...
        mockRequest.expects(atLeastOnce()).method("getPathInfo").will(returnValue("/testProvider/testFactory/connection-0/start"));
