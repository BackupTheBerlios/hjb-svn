...
public class CreateSubscriberGeneratorTest extends
    ...
    public void testMatchWorksCorrectly() {
        ...
        assertTrue(generator.matches("/foo/baz/connection-5/session-4/create-durable-subscriber"));
    }

    public void testJMSCommandAndItsRunnerAreGeneratedCorrectly() {
        Mock mockRequest = generateMockRequest();
        mockRequest.expects(atLeastOnce()).method("getPathInfo").will(returnValue("/testProvider/testFactory/connection-0/session-0/create-durable-subscriber"));
