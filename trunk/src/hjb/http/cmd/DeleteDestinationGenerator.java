...
/**
 * <code>DeleteDestinationGenerator</code> is the
 * <code>JMSCommandGenerator</code> that produces {@link DeleteDestination}.
 * 
 ...
 * @author Tim Emiola
 */
public class DeleteDestinationGenerator extends PatternMatchingCommandGenerator {
    ...
    protected void constructCommandFrom(HttpServletRequest request, HJBRoot root) {
        ...
        this.generatedCommand = new DeleteDestination(walker.findProvider(providerName),
                                                      destinationName);
    }
