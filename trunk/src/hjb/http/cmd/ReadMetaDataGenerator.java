...
/**
 * <code>ReadMetaDataGenerator</code> is the <code>JMSCommandGenerator</code>
 * that produces {@link ReadMetaData}.
 * 
 ...
 * @author Tim Emiola
 */
public class ReadMetaDataGenerator extends PatternMatchingCommandGenerator {
    ...
    private static Pattern PATH_MATCHER = Pattern.compile("^/(\\w+)/([^/]+)/connection-(\\d+)/metadata$");
}
