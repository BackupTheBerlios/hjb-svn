...
/**
 * <code>DeleteProviderGenerator</code> is the
 * <code>JMSCommandGenerator</code> that produces {@link DeleteProvider}.
 * 
 ...
 * @author Tim Emiola
 */
public class DeleteProviderGenerator extends PatternMatchingCommandGenerator {
    ...
    protected void constructCommandFrom(HttpServletRequest request, HJBRoot root) {
        ...
        this.generatedCommand = new DeleteProvider(root, providerName);
    }
