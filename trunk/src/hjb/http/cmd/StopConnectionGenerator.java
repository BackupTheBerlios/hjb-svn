...
/**
 * <code>StopConnectionGenerator</code> is the
 * <code>JMSCommandGenerator</code> that produces {@link StopConnection}.
 * 
 ...
 * @author Tim Emiola
 */
public class StopConnectionGenerator extends PatternMatchingCommandGenerator {
    ...
    protected void constructCommandFrom(HttpServletRequest request, HJBRoot root)
        ...
        HJBConnection connection = walker.findConnection(providerName,
                                                         factoryName,
                                                         connectionIndex);
        this.generatedCommand = new StopConnection(connection);
    }
