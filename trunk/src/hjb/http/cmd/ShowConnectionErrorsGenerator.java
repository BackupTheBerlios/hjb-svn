...
/**
 * <code>ShowConnectionErrorsGenerator</code> is the
 * <code>JMSCommandGenerator</code> that produces {@link ShowConnectionErrors}.
 * 
 ...
 * @author Tim Emiola
 */
public class ShowConnectionErrorsGenerator extends
    ...
    private transient ShowConnectionErrors generatedCommand;

    private static final Pattern PATH_MATCHER = Pattern.compile("^/(\\w+)/(.+)/"
            + PathNaming.CONNECTION + "-(\\d+)/errors$");
}
