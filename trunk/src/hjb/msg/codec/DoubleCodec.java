...
/**
 * <code>DoubleCodec</code> is used to encode/decode between double values in
 ...
 * @author Tim Emiola
 */
public class DoubleCodec extends BaseValueCodec {
    ...
    public boolean isEncoded(String value) {
        try {
            ...
            if (result) Double.valueOf(m.group(1));
            return result;
