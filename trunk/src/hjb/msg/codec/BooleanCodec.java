...
/**
 * <code>BooleanCodec</code> is used to encode/decode between boolean values
 * in JMS {@link javax.jms.Message}s and their encoded string versions in
 ...
 * @author Tim Emiola
 */
public class BooleanCodec extends BaseValueCodec {
    ...
    public boolean isEncoded(String value) {
        try {
            ...
            if (result) Boolean.valueOf(m.group(1));
            return result;
